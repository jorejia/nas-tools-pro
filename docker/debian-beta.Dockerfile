...
RUN set -xe && \
    ...
    apt-get install -y $(echo $(wget --no-check-certificate -qO- https://raw.githubusercontent.com/jorejia/nas-tools-pro/beta/package_list_debian.txt)) && \
    ...
    pip install cython && \
    pip install -r https://raw.githubusercontent.com/jorejia/nas-tools-pro/beta/requirements.txt && \
    # Clear
