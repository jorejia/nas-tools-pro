...
RUN set -xe && \
    ...
    apt-get install -y $(echo $(wget --no-check-certificate -qO- https://raw.githubusercontent.com/jorejia/nas-tools-pro/master/package_list_debian.txt)) && \
    ...
    pip install cython && \
    pip install -r https://raw.githubusercontent.com/jorejia/nas-tools-pro/master/requirements.txt && \
    # Clear
...
ENV S6_SERVICES_GRACETIME=30000 \
    ...
    REPO_URL="https://github.com/jorejia/nas-tools-pro.git" \
